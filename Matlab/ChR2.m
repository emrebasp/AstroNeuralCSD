...
% varied gamma_i
nOfSamples = 25;
initRange1 = 4; % for gamma_ei, gamma_ii
finRange1 = 16;
% initRange2 = 0; % for gamma_i
% finRange2 = 12;
initRange2 = 0; % for gamma_i
finRange2 = 36;

parRange1 = linspace(initRange1,finRange1,nOfSamples); % parameter range for gamma_ei, gamma_ii
parRange2 = linspace(initRange2,finRange2,nOfSamples); % parameter range for gamma_i
...
figure;
plot(parRange2, propagationSpeed, 'bo','MarkerFaceColor', 'b', 'LineWidth', 2);
axis([parRange2(1) parRange2(end) 0 6])
grid off;
xlabel('\gamma_i');
ylabel('Speed');
...
fileName = sprintf('ChR2_%s.png', timestamp);
...
% Define the filename with the timestamp
fileName = sprintf('ChR2_%s.csv', timestamp);
